...
export interface ApiCalcHistoryCalcHistory extends Struct.CollectionTypeSchema {
  collectionName: 'calc_histories';
  info: {
    description: '';
    displayName: 'Calc-history';
    pluralName: 'calc-histories';
    singularName: 'calc-history';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::calc-history.calc-history'
    > &
      Schema.Attribute.Private;
    polzovatel: Schema.Attribute.Relation<
      'manyToOne',
      'api::polzovatel.polzovatel'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiCalculationCalculation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    platform: Schema.Attribute.Enumeration<
      ['Google', 'VK', '\u042F\u043D\u0434\u0435\u043A\u0441']
    >;
    polzovatels: Schema.Attribute.Relation<
      'manyToMany',
      'api::polzovatel.polzovatel'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPolzovatelPolzovatel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    calc_histories: Schema.Attribute.Relation<
      'oneToMany',
      'api::calc-history.calc-history'
    >;
    calculations: Schema.Attribute.Relation<
      'manyToMany',
      'api::calculation.calculation'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::calc-history.calc-history': ApiCalcHistoryCalcHistory;
      'api::calculation.calculation': ApiCalculationCalculation;
      'api::polzovatel.polzovatel': ApiPolzovatelPolzovatel;
